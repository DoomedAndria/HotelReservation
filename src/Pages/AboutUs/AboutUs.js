  ...
  return(
    <div>
      ...
      <div className={styles.contentCont}>
        ...
        <h3 style={{width:"800px",marginBottom:"50px",color:"#2d3c5d"}}>Welcome to Heaven Harbor, where paradise is not just a destination but an experience. Nestled in the heart of New Jersey, our luxurious hotel offers an oasis of tranquility and elegance. Whether you’re here for a romantic getaway, a family vacation, or a business trip, Heaven Harbor provides the perfect backdrop for unforgettable moments.</h3>

        <div className={styles.sect}>
          <div className={styles.child}>
            <h2>Our Story</h2>
            <p>Heaven Harbor was founded with a vision to create a sanctuary where guests can escape the ordinary and embrace the extraordinary. Inspired by the serene beauty of New Jersey, our hotel blends modern luxury with timeless charm. Every detail, from our meticulously designed rooms to our world-class amenities, is crafted to ensure your stay is nothing short of perfection.</p>
          </div>
          <div className={styles.child}>
